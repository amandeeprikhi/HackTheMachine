...
const handlers = {
    'LaunchRequest': function () {
      // attributes that act as session storage
        this.attributes.store = {
            ...
            'products':{
                'Product1':{
                    'name': '1. SoftWidget Ultra Charge Bluetooth Speaker.',
                ...
                'Product2':{
                    'name': '2. SoftWidget S Buds Wireless Bluetooth Earbuds.',
                ...
                'Product3':{
                    'name': '3. SoftWidget Wake-Up Light with Alarm Clock.',
    ...
    'ProductIntent': function(){
      // Below is how we use the attributes
        //this.response.speak("Available products are: " + this.attributes.store.products.Product1.name +". The "+ this.attributes.store.products.Product2.name).listen("Testing");
        //this.response.speak("Available products are: " + this.attributes.store.products.Product1.name +"  "+ this.attributes.store.products.Product2.name).listen("Testing");
      this.response.speak("Available products are: " + this.attributes.store.products.Product1.name +" " + this.attributes.store.products.Product2.name +"  "+ this.attributes.store.products.Product3.name).listen("Testing");
        this.emit(':responseReady');
    },
    'CartIntent': function(){
      // Below is how we use the attributes
